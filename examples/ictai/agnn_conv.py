...
class AGNNConv_quant(MessagePassing):
    ...
    """
    def __init__(self, requires_grad=True, num=1, **kwargs):
        super(AGNNConv_quant, self).__init__(aggr='add', **kwargs)
    ...
    def message(self, edge_index_i, x_j, x_norm_i, x_norm_j,
        ...
        x_norm_i = quantize(x_norm_i, num_bits=aggr_bit, dequantize=True)
        x_norm_j = quantize(x_norm_j, num_bits=aggr_bit, dequantize=True)
