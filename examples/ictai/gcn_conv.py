...
# from typing import Adj, OptTensor, PairTensor
...
class GCNConv(MessagePassing):
    ...
    def forward(self, x: Tensor, edge_index: Adj,
                edge_weight: OptTensor = None, iteration=0) -> Tensor:
        """"""
        ...
        # print(x)
        # with open("feature_map.pkl", "wb") as fmp:
        #     pickle.dump(x.cpu().detach(), fmp)
        x = torch.matmul(x, self.weight)

        # with open("weights/weight-{}.pkl".format(iteration), "wb") as weg:
        #     pickle.dump(self.weight.cpu().detach(), weg)
        # print(self.weight)
        ...
        # print(out)
        # with open("feature_map.pkl", "wb") as fmp:
        #     pickle.dump(out.cpu().detach(), fmp)
        # sys.exit()
        return out
